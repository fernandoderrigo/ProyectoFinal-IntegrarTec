...
function LoginPage() {
  ...
  return (
    <div className="text-white h-screen p-5 flex flex-col justify-between items-center" style={backgroundStyle}>
      <h1 className="text-3xl font-bold mb-5">Login</h1>

      <form onSubmit={handleSubmit} className="w-full max-w-sm">
        <div className="mb-4 flex items-center bg-gray-800 rounded p-2.5 relative">
          <input
            type="email"
            value={email}
      ...
      <div className="flex justify-between w-full max-w-sm mt-5 px-2.5">
